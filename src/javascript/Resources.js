...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            // Car bike
            { name: 'carBikeChassis', source: './models/car/bike/chassis.glb' },
            { name: 'carBikeWheel', source: './models/car/bike/wheel.glb' },
            { name: 'carBikeAntena', source: './models/car/bike/antena.glb' },
